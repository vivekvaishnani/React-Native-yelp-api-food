...
function withUnimodules(inputWebpackConfig = {}, env = {}, argv = {}) {
    ...
    if (!inputWebpackConfig.module)
        ...
        inputWebpackConfig.module = Object.assign({}, inputWebpackConfig.module, { rules: [] });
    ...
    inputWebpackConfig.output = Object.assign({}, inputWebpackConfig.output, { publicPath });
    ...
    inputWebpackConfig.module = Object.assign({}, inputWebpackConfig.module, { rules });
    inputWebpackConfig.resolve = Object.assign({}, inputWebpackConfig.resolve, { symlinks: false, 
