...
function addCompressionPlugins(webpackConfig, config) {
    ...
    const gzipConfig = utils_1.overrideWithPropertyOrConfig(build.gzip, exports.DEFAULT_GZIP_OPTIONS, true);
    const brotliConfig = utils_1.enableWithPropertyOrConfig(build.brotli, exports.DEFAULT_BROTLI_OPTIONS, true);
